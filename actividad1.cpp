    ...
    do{
        ...
        switch(opcion){
            ...
            int h;
				...
				cout<<"*(Incluyendo el nivel 0 (raiz))*"<<endl;
            break;
            case 4: 
				cantidad = CantidadN(arbol);
				cout<<endl;
            	cout << " El arbol tiene: "<< cantidad <<" nodos"<<endl;

            break;
            case 5:
				sumas = SumaN(arbol);
				cout<<endl;
				cout<<" La suma de los valores de los nodos es de: "<< sumas <<endl;
            break;
